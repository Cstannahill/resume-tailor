...
- API doc index: `resume-tailor-api/docs/README.md`. Tailor pipeline: `resume-tailor-api/docs/retrieval-tailoring.md`. Studio list/GET shape mismatches: `resume-tailor-frontend/docs/studio-data-shapes.md`.
