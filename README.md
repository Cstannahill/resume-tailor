...
- Auth identity (`name` vs `displayName`), stale JWT sessions, and conversation UI/API shapes: `resume-tailor-api/docs/README.md` and `resume-tailor-frontend/docs/auth-and-coach-contracts.md`.
